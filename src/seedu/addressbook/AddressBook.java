...
public class AddressBook {
    ...
    private static final String COMMAND_EDIT_DESC = "Edit a person's particulars in the Address Book";
     ...
     */
    private static final String PERSON_PROPERTY_NAME = "PERSON_PROPERTY_NAME";
    private static final String PERSON_PROPERTY_PHONE = "PERSON_PROPERTY_PHONE";
    private static final String PERSON_PROPERTY_EMAIL = "PERSON_PROPERTY_EMAIL";
    ...
    private static void showWelcomeMessage() {
        String[] concatMessages = {DIVIDER, DIVIDER, VERSION, MESSAGE_WELCOME, DIVIDER};
        showToUser(concatMessages);
    }

    private static void showResultToUser(String result) {
        String[] concatMessages = {result, DIVIDER};
        showToUser(concatMessages);
    }
    ...
    private static void echoUserCommand(String userCommand) {
        String[] concatMessages = {"[Command entered:" + userCommand + "]"};
        showToUser(concatMessages);
    }
    ...
    private static void processProgramArgs(String[] args) {
        if (args.length >= 2) {
            String[] concatMessages = {MESSAGE_INVALID_PROGRAM_ARGS};
            showToUser(concatMessages);
            exitProgram();
        }
    ...
    private static void setupGivenFileForStorage(String filePath) {
        ...
        if (!isValidFilePath(filePath)) {
            String[] concatMessages = {String.format(MESSAGE_INVALID_FILE, filePath)};
            showToUser(concatMessages);
            exitProgram();
        }
    ...
    private static void exitProgram() {
        String[] concatMessages = {MESSAGE_GOODBYE, DIVIDER, DIVIDER};
        showToUser(concatMessages);
        System.exit(0);
    }
    ...
    private static void setupDefaultFileForStorage() {
        String[] concatMessages = {MESSAGE_USING_DEFAULT_FILE};
        showToUser(concatMessages);
    ...
    */
    ...
    private static void showToUser(ArrayList<HashMap<String,String>> persons) {
        ...
        String[] concatMessages = {listAsString};
        showToUser(concatMessages);
    ...
    private static void createFileIfMissing(String filePath) {
        ...
        String[] concatMessages = {String.format(MESSAGE_ERROR_MISSING_STORAGE_FILE, filePath)};
        showToUser(concatMessages);

        try {
            storageFile.createNewFile();
            String[] concatMessages2 = {String.format(MESSAGE_STORAGE_FILE_CREATED, filePath)};
            showToUser(concatMessages2);
        } catch (IOException ioe) {
            String[] concatMessages2 = {String.format(MESSAGE_ERROR_CREATING_STORAGE_FILE, filePath)};
            showToUser(concatMessages2);
            exitProgram();
        }
    }
    ...
    private static ArrayList<HashMap<String,String>> loadPersonsFromFile(String filePath) {
        ...
        if (!successfullyDecoded.isPresent()) {
            String[] concatMessages = {MESSAGE_INVALID_STORAGE_FILE_CONTENT};
            showToUser(concatMessages);
            exitProgram();
        }
    ...
    private static ArrayList<String> getLinesInFile(String filePath) {
        ...
        try {
            ...
            String[] concatMessages = {String.format(MESSAGE_ERROR_READING_FROM_FILE, filePath)};
            showToUser(concatMessages);
            exitProgram();
        }
        return lines;
    ...
    private static void savePersonsToFile(ArrayList<HashMap<String,String>> persons, String filePath) {
        ...
        try {
            ...
            String[] concatMessages = {String.format(MESSAGE_ERROR_WRITING_TO_FILE, filePath)};
            showToUser(concatMessages);
            exitProgram();
        }
    }
...
//        final HashMap<String,String> person = new String[PERSON_DATA_COUNT];
